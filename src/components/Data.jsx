export const Data = ({ location, isLoading }) => {
    ...
    return (
        <div className="flex flex-col md:flex-row  justify-around items-center py-5 px-4 absolute top-[150px] md:top-[190px] h-auto  md:h-[164px] w-[90%] md:w-[80%] bg-white rounded-[15px] shadow-xl left-1/2 transform -translate-x-1/2 z-10 font-rubik text-[18px] md:text-[24px] font-medium md:font-bold">
